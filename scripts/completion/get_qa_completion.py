#!/usr/bin/env python3
"""
Given a data file with questions and retrieval results to use, run VLLM to get responses.
"""
import argparse
import dataclasses
import json
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gold-index-position",
        help="Gold index position in the prompt. lost-in-the-middle: [0, 4, 9, 14, ...]. every: [0, 1, 2, 3, ...]. rotate: shuffle and circularly construct input contexts.",
        type=str,
